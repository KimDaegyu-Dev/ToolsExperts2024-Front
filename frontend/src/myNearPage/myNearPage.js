...
const MynearPage = () => (
  <>
    ...
    {/* 상단 부분 */}
    <div>
    <img src={calendar} alt="calendar" className="calendar" style={{ top: "90px", left: "145px" }} />
    <div className="datef" style={{ top: "100px", left: "190px" }}>
        2024. 07. 21
    </div>
    <img src={position} alt="position" className="position" style={{ top: "90px", left: "330px" }} />
    <div className="placef" style={{ top: "100px", left: "370px" }}>
        부산광역시 전체
    </div>
    <img src={arrow} alt="arrow" className="arrow" style={{ top: "100px", left: "505px" }} />

...
import star from "../../../../public/assets/star.png"; // 별 아이콘
import blueStar from "../../../../public/assets/blueStar.png"; // 평점 별 아이콘
import arrow from "../../../../public/assets/arrow.png"; // 별 아이콘
...
function Review({ name, date, content }) {
  return (
    <>
      ...
      <Image className="review-star" src={blueStar} alt="blueStar" />
      <Image className="review-star" src={blueStar} alt="blueStar" />
      <Image className="review-star" src={blueStar} alt="blueStar" />
      <Image className="review-star" src={blueStar} alt="blueStar" />
      <Image className="review-star" src={blueStar} alt="blueStar" />
    ...
    <>
      ...
      <div className="rating">
        <p className="rating-text">
          ...
          <Image className="rating-star" src={blueStar} alt="blueStar" />
          <Image className="rating-star" src={blueStar} alt="blueStar" />
          <Image className="rating-star" src={blueStar} alt="blueStar" />
          <Image className="rating-star" src={blueStar} alt="blueStar" />
          <Image className="rating-star" src={blueStar} alt="blueStar" />
        ...
        <div className="review-top">
          ...
          <Image className="latest-arrow" src={arrow} alt="arrow" />
          <p className="all">전체보기</p>
          <Image className="all-arrow" src={arrow} alt="arrow" />
        </div>
